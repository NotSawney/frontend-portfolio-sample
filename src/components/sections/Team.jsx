...
function TeamCard({ member, delay }) {
  ...
  return (
    <motion.div
      ...
      style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '24px', padding: '3px', transition: 'border-color 0.3s ease' }}
    ...
    >
      <div style={{
        ...
        <div style={{ fontWeight: 700, color: 'var(--color-heading)', fontSize: '15px', marginBottom: '5px', letterSpacing: '-0.2px' }}>
          {member.name}
        </div>
